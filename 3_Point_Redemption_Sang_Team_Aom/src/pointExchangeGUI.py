...
_ = Label(Tops,font=("TH Sarabun New",30,"bold"),text="ร้านค้าแลกแต้ม",fg="Blue",bd=10,anchor="w")
_.grid(row=0,column=0)

#Option 1
_ = Button(foption,width=10,padx=0,pady=0,bd=8,fg="black",font=("TH Sarabun New",20,"bold"),
    text="Read UID",bg="powder blue").grid(row=0,column=0)
_ = Button(foption,width=10,padx=0,pady=0,bd=8,fg="black",font=("TH Sarabun New",20,"bold"),
    text="Email",bg="powder blue").grid(row=1,column=0)
_ = Button(foption,width=10,padx=0,pady=0,bd=8,fg="black",font=("TH Sarabun New",20,"bold"),
    text="Send OTP",bg="powder blue").grid(row=2,column=0)
_ = Button(foption,width=10,padx=0,pady=0,bd=8,fg="black",font=("TH Sarabun New",20,"bold"),
    text="ปุ่มดึงแต้ม",bg="powder blue").grid(row=3,column=0)



# Option 2
_ = Label(foption2,width=20,padx=0,pady=0,bd=8,fg="black",font=("TH Sarabun New",20,"bold"),
    textvariable=userUID,bg="powder blue").grid(row=0,column=0,columnspan=2)
_ = Label(foption2,width=20,padx=0,pady=0,bd=8,fg="black",font=("TH Sarabun New",20,"bold"),
    textvariable=mypoint,bg="powder blue").grid(row=1,column=0,columnspan=2)
_ = Label(foption2,width=20,padx=0,pady=0,bd=8,fg="Red",font=("TH Sarabun New",20,"bold"),
    textvariable=itempoint,bg="Yellow").grid(row=2,column=0,columnspan=2)
_ = Button(foption2,width=10,padx=0,pady=0,bd=8,fg="black",font=("TH Sarabun New",20,"bold"),
    text="Reset",bg="powder blue",command=btnReset).grid(row=3,column=0)
_ = Button(foption2,width=10,padx=0,pady=0,bd=8,fg="black",font=("TH Sarabun New",20,"bold"),
    text="ยืนยันการแลก",bg="red").grid(row=3,column=1)
...
_ = Button(fitem,width=10,bd=3,fg="black",font=("TH Sarabun New",10,"bold"),
    text="เลือก",bg="powder blue",command=lambda name="pencill", pts=10: add_points(name, pts)).grid(row=3,column=0)
...
_ = Button(fitem,width=10,bd=3,fg="black",font=("TH Sarabun New",10,"bold"),
    text="เลือก",bg="powder blue",command=lambda name="pen", pts=20: add_points(name, pts)).grid(row=3,column=1)
...
_ = Button(fitem,width=10,bd=3,fg="black",font=("TH Sarabun New",10,"bold"),
    text="เลือก",bg="powder blue",command=lambda name="koplao", pts=50: add_points(name, pts)).grid(row=3,column=2)
...
_ = Button(fitem,width=10,bd=3,fg="black",font=("TH Sarabun New",10,"bold"),
    text="เลือก",bg="powder blue",command=lambda name="liquid", pts=70: add_points(name, pts)).grid(row=7,column=0)
...
_ = Button(fitem,width=10,bd=3,fg="black",font=("TH Sarabun New",10,"bold"),
    text="เลือก",bg="powder blue",command=lambda name="heartbeat", pts=90: add_points(name, pts)).grid(row=7,column=1)
...
_ = Button(fitem,width=10,bd=3,fg="black",font=("TH Sarabun New",10,"bold"),
    text="เลือก",bg="powder blue",command=lambda name="bag", pts=120: add_points(name, pts)).grid(row=7,column=2)
...
_ = Button(fitem,width=10,bd=3,fg="black",font=("TH Sarabun New",10,"bold"),
    text="เลือก",bg="powder blue",command=lambda name="tshirt", pts=200: add_points(name, pts)).grid(row=11,column=0)
...
_ = Button(fitem,width=10,bd=3,fg="black",font=("TH Sarabun New",10,"bold"),
    text="เลือก",bg="powder blue",command=lambda name="cup", pts=300: add_points(name, pts)).grid(row=11,column=1)
...
_ = Button(fitem,width=10,bd=3,fg="black",font=("TH Sarabun New",10,"bold"),
    text="เลือก",bg="powder blue",command=lambda name="bear", pts=400: add_points(name, pts)).grid(row=11,column=2)
